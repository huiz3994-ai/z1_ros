...
{
  time_open ++;
  if( time_open > 190 && time_open < 200 && FF == true){
    current_target -= step_size;
    FF = false;
  }else if (time_open > 210 && time_open < 250){
    current_target = 0.1;
  }else if( time_open > 430 && time_open < 450 && SS == true){
    current_target -= step_size;
    SS = false;
  }else if (time_open > 460 && time_open < 500){
    current_target = 0.1;
  }else if( time_open > 640 && time_open < 680 && TT == true){
    current_target -= step_size;
    TT = false;
  }else if (time_open > 710 && time_open < 750){
    current_target = 0.1;
  }
