/********v1.6 版本介绍
[配合 v1.6 launch 文件使用，用于单机械臂遥操作，已屏蔽不必要的控制台输出。——最后编辑与2025年04月17日 by张耀华]
...
void goalPositionsCallback(const std_msgs::Float64MultiArray::ConstPtr& msg) {
    if (msg->data.size() == 6) {
        ...
        ROS_INFO_STREAM_THROTTLE(1.0,"[GOAL] New target received!");
    } else {
...
int main(int argc, char** argv) {
    ...
    const std::vector<double> DEFAULT_GOALS = {0.0, 0.0, -0.005, -0.074, 0.0, 0.0};//官方“forward”姿态0.0, 1.5, -1.0, -0.54, 0.0, 0.0
