...
int main(int argc, char** argv) {
    ...
    const std::vector<double> DEFAULT_GOALS = {0.0, 0.0, -0.005, -0.074, 0.0, 0.0};//此为零位，我的“forward”姿态为{0.0, 1.3, -1.0, -0.32, 0.0, 0.0}
    //const std::vector<double> DEFAULT_GOALS = {0.0, 1.5, -1.0, -0.54, 0.0, 0.0};//(可选)此为 forward 工作位置
